    ...
    function addHoverDialog(parentTitleText) {
        ...
        h4Elements.forEach(h4 => {
            h4.addEventListener('mouseenter', function() {
                ...
                tooltip.style.top = `${rect.bottom + window.scrollY + 5}px`;  // 5px below the h4 element
                tooltip.style.left = `${rect.left + window.scrollX + rect.width / 2 - tooltipWidth / 2}px`;  // Centered horizontally
